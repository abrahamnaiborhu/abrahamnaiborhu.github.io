...
export function Contact() {
  return <React.Fragment>
    <section id="contact" className="section wrap contact" aria-labelledby="contact-title">
      ...
      <p>For professional opportunities, technical collaboration, or engineering discussions, reach me by email.</p>
      <div className="actions"><a className="button primary" href={`mailto:${profile.email}`}>Email Abraham <span aria-hidden="true">↗</span></a></div>
...
export function Footer() {
  return <footer className="site-footer wrap">
    ...
    <nav aria-label="Footer"><a href={profile.github}>GitHub</a><a href={profile.writing}>Dev.to</a><a href="#home">Back to top ↑</a></nav>
  </footer>;
}
