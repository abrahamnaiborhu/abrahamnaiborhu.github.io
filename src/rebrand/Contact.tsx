  ...
  return (
    <React.Fragment>
      <section
        ref={scope}
        id="contact"
        className="section wrap contact"
        aria-labelledby="contact-title"
      >
        <p className="eyebrow">Contact</p>
        <h2 id="contact-title">
          Let&apos;s talk about cloud, platform engineering, or infrastructure.
        </h2>
        <p>
          For professional opportunities, technical collaboration, or engineering discussions, the
          best ways to reach me are email or LinkedIn.
        </p>
        ...
        <p id="resume-note" className="metadata">
          <a className="text-link" href={profile.resumePdf} download>
