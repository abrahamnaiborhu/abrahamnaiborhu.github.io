...
3. Audit availability, final browser/accessibility/performance certification, current Resume and domain cutover remain open. No Lighthouse or award score is claimed.
...
5. The public Resume link is omitted rather than serving the outdated PDF. Contact remains usable.
